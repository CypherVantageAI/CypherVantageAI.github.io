...
export function showModal(title, contentHtml) {
  ...
  // If a fullscreen pane is active, append modal inside it so it renders on top-layer
  const activeFullscreenPane = document.querySelector('.view-fullscreen-mode');
  if (activeFullscreenPane) {
    activeFullscreenPane.appendChild(modal);
