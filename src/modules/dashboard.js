  ...
  if (activeDashboardSubTab === 'overview') {
      ...
      <div style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
        ...
        <div class="dashboard-card" style="padding: 15px; margin: 0; background: linear-gradient(135deg, rgba(6, 182, 212, 0.05), rgba(0,0,0,0)); border: 1px solid rgba(6, 182, 212, 0.2); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
          ...
          <div style="display: flex; gap: 6px; align-items: center;">
            ...
            <button class="btn btn-secondary btn-xs" onclick="window.triggerDynamicExport('pptx', 'board-pack')" style="font-size: 0.65rem; padding: 4px 8px;">📊 Board Pack - DOC</button>
          </div>
        </div>
        ...
        <div style="display: flex; gap: 20px; flex-wrap: wrap; width: 100%;">
          ...
          <div style="flex: 1; min-width: 260px; display: flex; flex-direction: column; gap: 15px;">
            ...
            <div class="dashboard-card" style="padding: 15px; margin: 0; display: flex; flex-direction: column; gap: 8px;">
              ...
              <div style="margin-top: 8px; border-top: 1px dashed rgba(255,255,255,0.08); padding-top: 8px; display: flex; justify-content: flex-end;">
                <button class="btn btn-primary btn-xs" onclick="window.switchTab('manager-dora'); setTimeout(() => { if (typeof window.switchDoraTab === 'function') window.switchDoraTab('traceability'); }, 50);" style="font-size: 0.68rem; padding: 5px 12px; background: linear-gradient(135deg, #06b6d4, #8b5cf6); color: #fff; border: none; font-weight: 700; display: flex; align-items: center; gap: 5px; cursor: pointer;">
                  🕸️ Open Traceability Lineage Map ➔
                </button>
              </div>
            </div>
          </div>
          ...
          <div style="display:flex; flex-direction:column; gap:10px;">
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; padding:10px; border:1px solid var(--border-color); border-radius:6px; background:rgba(255,255,255,0.01); flex-wrap:wrap; gap:10px;">
              ...
              <div style="display:flex; gap:6px;">
                ...
                <button class="btn btn-secondary btn-xs" onclick="window.triggerDynamicExport('pptx', 'board-pack')" style="font-size:0.64rem; color:#8b5cf6;">📊 DOC</button>
              </div>
            </div>
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; padding:10px; border:1px solid var(--border-color); border-radius:6px; background:rgba(255,255,255,0.01); flex-wrap:wrap; gap:10px;">
              ...
              <div style="display:flex; gap:6px;">
                ...
                <button class="btn btn-secondary btn-xs" onclick="window.triggerDynamicExport('pptx', 'regulator-pack')" style="font-size:0.64rem; color:#8b5cf6;">📊 DOC</button>
              </div>
            </div>
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; padding:10px; border:1px solid var(--border-color); border-radius:6px; background:rgba(255,255,255,0.01); flex-wrap:wrap; gap:10px;">
              ...
              <div style="display:flex; gap:6px;">
                ...
                <button class="btn btn-secondary btn-xs" onclick="window.triggerDynamicExport('pptx', 'audit-pack')" style="font-size:0.64rem; color:#8b5cf6;">📊 DOC</button>
              </div>
            </div>
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; padding:10px; border:1px solid var(--border-color); border-radius:6px; background:rgba(255,255,255,0.01); flex-wrap:wrap; gap:10px;">
              ...
              <div style="display:flex; gap:6px;">
                ...
                <button class="btn btn-secondary btn-xs" onclick="window.triggerDynamicExport('pptx', 'dora-matrix')" style="font-size:0.64rem; color:#8b5cf6;">📊 DOC</button>
              </div>
            </div>
          </div>
        </div>
    ...
    if (kpiDora) {
      kpiDora.addEventListener('click', () => {
        showModal('DORA Compliance Score', `
          <div style="font-size:0.75rem; line-height:1.5; display:flex; flex-direction:column; gap:8px;">
            <div><b>DORA Compliance Index: ${doraScore}%</b></div>
            <div>Weighted calculation: ((Compliant + 0.5 * Partial) / Total Obligations) * 100</div>
            <div style="margin-top: 4px;">Compliant: ${compliantObligations} Articles | Partial: ${partialObligations} Articles | Non-Compliant: ${totalObligations - compliantObligations - partialObligations} Articles.</div>
            <div style="margin-top: 10px; border-top: 1px solid rgba(255,255,255,0.08); padding-top: 8px;">
              <button class="btn btn-primary btn-xs" onclick="const m = document.querySelector('.modal-overlay'); if (m) { m.classList.add('hidden'); m.style.display = 'none'; } window.switchTab('manager-dora'); setTimeout(() => { if (typeof window.switchDoraTab === 'function') window.switchDoraTab('traceability'); }, 50);" style="width: 100%; font-size: 0.68rem; padding: 6px; font-weight:700;">
                🕸️ Open Traceability Lineage Map
              </button>
            </div>
          </div>
      ...
      <div style="display: flex; gap: 20px; flex-wrap: wrap; width: 100%;">
        ...
        <div class="dashboard-card map-card" style="flex: 1.8; min-width: 500px; padding: 15px; display: flex; flex-direction: column; gap: 12px; box-sizing: border-box;">
          ...
          <div class="map-systems-section" style="border-top: 1px solid rgba(255,255,255,0.06); padding-top: 10px; display: flex; flex-direction: column;">
            ...
            <div id="map-systems-grid" class="resilience-systems-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(14rem, 1fr)); gap: 8px; overflow-y: auto; min-height: 30rem; max-height: 34rem; padding-right: 4px;">
...
window.triggerDynamicExport = function(format, reportType) {
  ...
  // Intercept DOC format to directly invoke the doc outline downloader
  if (format === 'pptx') {
    if (typeof window.downloadMockDoc === 'function') {
      window.downloadMockDoc();
      return;
    }
  }
  ...
  if (!exportWindow) {
    alert('Please allow popups to open the PDF/Doc report viewer.');
    return;
  }
  ...
  exportWindow.document.write(`
    ...
    <html>
      ...
      <body>
        <div class="toolbar">
          <div>
            <strong style="color:#0f172a; font-size:14px;">${format === 'pptx' ? 'DOC' : format.toUpperCase()} Document Preview Mode</strong>
            <span style="font-size:12px; color:#64748b; display:block;">Click "${format === 'pptx' ? 'Save as DOC / Print' : 'Save as PDF / Print'}" to export clean document slides.</span>
          </div>
          <div>
            <button class="btn btn-secondary" onclick="window.close()">Close</button>
            <button class="btn" onclick="window.print()">🖨️ ${format === 'pptx' ? 'Save as DOC / Print' : 'Save as PDF / Print'}</button>
          </div>
        </div>
        <div id="print-area">
          ${contentHtml}
