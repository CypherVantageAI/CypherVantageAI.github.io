...
const DEFAULT_STATE = {
  ...
  scenarios: [
    {
      id: 'sim-cloud-outage',
      name: 'Cloud Outage (AWS us-east-1 Region Loss)',
      description: 'Total multi-datacenter power & networking failure in AWS Virginia region, dropping primary cloud clusters.',
      threatCategory: 'Infrastructure',
      severity: 'Critical',
      likelihood: 3,
      impactRating: 5,
      servicesAffected: ['srv-001', 'srv-002', 'srv-004'],
    ...
    {
      id: 'sim-ransomware',
      name: 'Ransomware Data Integrity Hijack',
      description: 'LockBit 3.0 automated malware payload encrypts core staging databases and Active Directory domain controllers.',
      threatCategory: 'Cyber',
      severity: 'Critical',
      likelihood: 4,
      impactRating: 5,
      servicesAffected: ['srv-001', 'srv-002', 'srv-003', 'srv-004'],
      backupStrategy: 'Warm Standby',
      detectionDelay: 15,
    ...
    {
      id: 'sim-third-party',
      name: 'Third Party Supplier & Subprocessor Failure',
      description: 'Unannounced global BGP routing drop and certificate revocation across Infosys and Cloudflare edge networks.',
    ...
    {
      id: 'sim-identity-compromise',
      name: 'Identity Compromise & Privileged Access Hijack',
      description: 'Sophisticated SIM-swap and OAuth token theft compromises domain admin credentials, locking IAM services.',
      threatCategory: 'Identity',
      severity: 'Critical',
      likelihood: 3,
      impactRating: 5,
      ...
      recoveryReadiness: 85
    },
    {
      id: 'sim-payment-failure',
      name: 'Payment Platform & Settlement Engine Failure',
      description: 'Database deadlock and queue saturation in core SWIFT & Faster Payments clearing engines during peak volume.',
    ...
    {
      id: 'sim-data-corruption',
      name: 'Data Corruption & Journal Synchronization Desync',
      description: 'Silent database byte corruption spreads to warm standby replicas before automated integrity checks detect anomaly.',
      threatCategory: 'Data',
      severity: 'High',
      likelihood: 2,
      impactRating: 4,
      servicesAffected: ['srv-001', 'srv-003'],
      backupStrategy: 'None',
      detectionDelay: 45,
      preventionEffectiveness: 65,
